...
def get_folds(df, plate_dictionary, platesperfold_dictionary, output_dir, name, waves = [1,3], plate_col = "Batch", index_col = "Sample_Name", wave_col = "Set"):
    df["Fold"] = 0
...
def explore_folds(df, name, output_dir, fold_col = "Fold", index_col = "Sample_Name", age_col = "age", sex_col = "sex", wave_col = "Set", plate_col = "Batch", color = "custom2"):
    # Aesthetic
